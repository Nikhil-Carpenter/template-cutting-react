        ...
        <div className="slider_container">
          ...
          >
            ...
            <div className="carousel_btn-box">
              ...
              <img src="user_assets/images/line.png" alt="" />
              <Link
          ...
          <div className="row">
            <div className="col-sm-6 col-md-4 col-lg-3">
              <div className="box">
                <Link to="">
                  <div className="img-box">
                    <img src="user_assets/images/p1.png" alt="" />
                  </div>
                  <div className="detail-box">
                    <h6>Ring</h6>
                    <h6>
            ...
            <div className="col-sm-6 col-md-4 col-lg-3">
              <div className="box">
                <Link to="">
                  <div className="img-box">
                    <img src="user_assets/images/p2.png" alt="" />
                  </div>
                  <div className="detail-box">
                    <h6>Watch</h6>
                    <h6>
            ...
            <div className="col-sm-6 col-md-4 col-lg-3">
              <div className="box">
                <Link to="">
                  <div className="img-box">
                    <img src="user_assets/images/p3.png" alt="" />
                  </div>
                  <div className="detail-box">
                    <h6>Teddy Bear</h6>
                    <h6>
            ...
            <div className="col-sm-6 col-md-4 col-lg-3">
              <div className="box">
                <Link to="">
                  <div className="img-box">
                    <img src="user_assets/images/p4.png" alt="" />
                  </div>
                  <div className="detail-box">
            ...
            <div className="col-sm-6 col-md-4 col-lg-3">
              <div className="box">
                <Link to="">
                  <div className="img-box">
                    <img src="user_assets/images/p5.png" alt="" />
                  </div>
                  <div className="detail-box">
                    <h6>Teddy Bear</h6>
                    <h6>
            ...
            <div className="col-sm-6 col-md-4 col-lg-3">
              <div className="box">
                <Link to="">
                  <div className="img-box">
                    <img src="user_assets/images/p6.png" alt="" />
                  </div>
                  <div className="detail-box">
                    <h6>Flower Bouquet</h6>
                    <h6>
            ...
            <div className="col-sm-6 col-md-4 col-lg-3">
              <div className="box">
                <Link to="">
                  <div className="img-box">
                    <img src="user_assets/images/p7.png" alt="" />
                  </div>
                  <div className="detail-box">
                    <h6>Watch</h6>
                    <h6>
            ...
            <div className="col-sm-6 col-md-4 col-lg-3">
              <div className="box">
                <Link to="">
                  <div className="img-box">
                    <img src="user_assets/images/p8.png" alt="" />
                  </div>
                  <div className="detail-box">
                    <h6>Ring</h6>
                    <h6>
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-lg-6">
                <div className="img-box">
                  <img src="user_assets/images/saving-img.png" alt="" />
                </div>
              </div>
              <div className="col-lg-6">
                <div className="detail-box">
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-4">
          <div className="box ">
            <div className="img-box">
              <svg version="1.1" id="Layer_1"   x="0px" y="0px" viewBox="0 0 512 512" style={{enableBackground:"new 0 0 512 512" }}>
                <g>
                  <g>
        ...
        <div className="col-md-4">
          <div className="box ">
            <div className="img-box">
              <svg version="1.1" id="Capa_1"  x="0px" y="0px" viewBox="0 0 490.667 490.667" style={{enableBackground:"new 0 0 490.667 490.667;"}}>
                <g>
                  <g>
        ...
        <div className="col-md-4">
          <div className="box ">
            <div className="img-box">
              <svg id="_30_Premium" height="512" viewBox="0 0 512 512" width="512" data-name="30_Premium">
                <g id="filled">
            ...
            <div className="row">
              <div className="col-md-5">
                <div className="img_container">
                  <div className="img-box">
                    <img src="user_assets/images/gifts.png" alt="" />
                  </div>
                </div>
              </div>
              <div className="col-md-7">
